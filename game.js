(() => {
  ...
  const TUTORIAL_COACH_STEPS = [
    ...
    {
      id: "scoreTips",
      text: "점수는 합체 점수, 배달 점수, 남은 시간 보너스, 콤보 보너스가 같이 더해져. 빠르게 합치고 바로 배달할수록 더 높아져!",
      wait: "next",
      highlight: [],
      reaction: "빠를수록 고득점!",
    },
    {
      id: "comboTips",
      text: "실수 없이 합체와 배달을 이어가면 콤보가 올라. 콤보 x8 또는 도시락 3개 연속 완성이면 피버가 켜져서 2발씩 발사돼!",
      wait: "next",
      highlight: [],
      reaction: "콤보와 피버!",
    },
    {
      id: "autoFireTips",
      text: "본 게임에서 도시락 2개를 완성하면 자동발사 버튼과 E키가 열려. 누르면 4초 동안 현재 타겟이나 배달칸으로 풀파워 연사해.",
      wait: "next",
      highlight: [],
      reaction: "자동발사는 2개 완성 후!",
    },
    {
      id: "boosterTips",
      text: "중간부터 나타나는 화살표 부스터는 닿은 재료를 화살표 방향으로 튕겨. 잘 맞으면 빠른 배달 루트가 되고, 빗나가면 흐름이 꼬일 수 있어.",
      wait: "next",
      highlight: [],
      reaction: "화살표는 방향 부스터!",
    },
    {
      id: "difficultyTips",
      text: "본 게임은 주문 재료, 필요한 단계, 중앙 타겟 위치가 매번 섞여. 시간이 지나고 완성 수가 늘면 더 높은 단계 주문이 자주 나와.",
      wait: "next",
      highlight: [],
      reaction: "난이도는 점점 상승!",
    },
    {
      id: "outro",
      text: "정리하면, 타겟을 맞춰 현재탄을 키우고 완성되면 위 칸에 배달해. 자동발사와 부스터는 고득점용 도구야. 이제 60초 러시 시작!",
      wait: "finish",
      highlight: [],
      reaction: "연습 끝!",
    },
